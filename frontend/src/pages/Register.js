...
export const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-8" data-testid="register-page">
      ...
      <div className="glass-card-heavy rounded-xl p-12 w-full max-w-md">
        ...
        <h2 className="text-2xl font-bold mb-8 text-center uppercase tracking-wide">Sign Up</h2>
        ...
        <div className="mt-8 text-center text-gray-400">
          ...
          <Link to="/login" className="text-primary hover:text-primary/80 font-semibold" data-testid="login-link">
            Sign In
          </Link>
        </div>
      </div>
